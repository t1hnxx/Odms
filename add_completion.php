...
<button type="button" class="btn btn-success btn-md float-end" style="color: white" data-bs-toggle="modal" data-bs-target="#choose">
       <i class="bi bi-file-earmark-plus text-white"></i> Add Completion Form </button>
...
<div class="modal fade" id="completionM" aria-hidden="true" aria-labelledby="completionM" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
    ...
    <?php	}
      ...
      <div class="mb-2">
        <span class="fw-bolder" style="color:#ec6d18; font-size:16px">Student Name:</span>
         <div class="fw-bolder fs-6 fst-italic" id="dito" style="color:#ec6d18"></div>
        </div>
          <br>
        <div class="row">
          <div class="col-sm-6">
            <label for="#semester" class="form-label fw-bolder" style="color:#ec6d18; font-size:16px">Semester</label>
            <select
          ...
          <div class="col-sm-6">
            <label for="#academic_year" class="form-label fw-bolder" style="color:#ec6d18; font-size:16px">Academic Year</label>
            <select
              class="form-select form-select-sm border-dark fw-bolder"
              name="academic_year"
              id="academic_year"
      ...
      <div class="row">
      <div class="col-sm-4">
      <label for="#subjectCode" class="fw-bolder" style="color:#ec6d18; font-size:16px">Subject Code</label>
          ...
          <div class="col-sm-4">
            <label for="#gradeP" class="form-label" style="color:#ec6d18; font-size:16px">Previous Grade</label>
            <input type="text" class="form-control border-black border-2 text-uppercase" id="gradeP" name="gradeP"  value="INC" disabled>
          </div>
          <div class="col-sm-4">
            <label for="#gradeF" class="form-label" style="color:#ec6d18; font-size:16px">Final Grade</label>
            <select
              class="form-select form-select-sm border-dark fw-bolder"
              name="gradeF"
              id="gradeF"
