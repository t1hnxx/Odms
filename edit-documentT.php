...
<br><br><br>
	...
	<div class="card rounded-0 border-dark ms-4 me-4" style="background-color:#fffcfa">
        ...
        if($rowmo['documentType'] == 'thesis' || $rowmo['documentType'] == 'journal'){?>        
        <span class="fw-bold" style="letter-spacing: 0.5px; color:#ec6d18">To decline submission, remove your name and choose "RETURN".</span>
       <?php } ?>
			<div class="row m-2" >
				...
				<?php
					if($rowmo['documentType']== "thesis"){
						...
						value = "'. $rowmo['documentName'] . '"
					  	disabled readonly/><small id="helpId" class="form-text text-danger opacity-75 fst-italic" style="font-size: small">Field cannot be edited</small>';
					}
					else{
						echo '
						<input
            ...
            <div class="col-md-6 mb-2 ">
              ...
              <button type="button" id="status" class="btn form-control" data-bs-toggle="modal" data-bs-target="#myModal" style="border: 2px solid #FF6F00; color:#FF6F00">
                Personnel is automatically picked when submitting
              </button>
              <?php }
                 else{?>
                  <button type="button" id="status" class="btn form-control" data-bs-toggle="modal" data-bs-target="#myModal" style="border: 2px solid #FF6F00; color:#FF6F00">
        ...
        ?>
			...
			<div class="row m-2">
              ...
              <p id="id_work_days">
              <?php if($rowmo['documentType']=='thesis'){
                  if($rowmo['documentStatus']=='submitted'){?>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="submitted" <?php if($rowmo["documentStatus"] == "submitted") echo "checked"; ?>><span>RECEIVED</span></label>
             ...
             <?php }elseif($rowmo['documentStatus']=='on_hand'){?>
                    ...
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="on_hand" <?php if($rowmo["documentStatus"] == "on_hand") echo "checked"; ?>><span>ON-HAND</span></label>
            ...
            <?php } elseif($rowmo['documentStatus']=='review'){?>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="submitted" <?php if($rowmo["documentStatus"] == "submitted") echo "checked"; ?>><span>SUBMITTED</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="on_hand" <?php if($rowmo["documentStatus"] == "on_hand") echo "checked"; ?>><span>ON-HAND</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="review" <?php if($rowmo["documentStatus"] == "review") echo "checked"; ?>><span>REVIEWING</span></label>
                    <label><input type="radio" id="documentStatus" name="documentStatus" value="pick-up" <?php if($rowmo["documentStatus"] == "pick-up") echo "checked"; ?>><span>FOR PICK-UP</span></label>
            ...
            <?php } elseif($rowmo['documentStatus']=='to_research'){?>
              ...
              <?php }else{
              echo "Error identifying the current Status";
            } 
            ...
            if($rowmo['documentStatus']=='submitted'){?>
              ...
              <label ><input type="radio" id="documentStatus" name="documentStatus" value="on_hand" <?php if($rowmo["documentStatus"] == "on_hand") echo "checked"; ?>><span>ON-HAND</span></label>
              <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="review" <?php if($rowmo["documentStatus"] == "review") echo "checked"; ?>><span>REVIEW</span></label>
              <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="graded" <?php if($rowmo["documentStatus"] == "graded") echo "checked"; ?>><span>MARK</span></label>
             
            
       <?php }elseif($rowmo['documentStatus']=='on_hand' || $rowmo['documentStatus']=='review'){?>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="submitted" <?php if($rowmo["documentStatus"] == "submitted") echo "checked"; ?>><span>RECEIVED</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="on_hand" <?php if($rowmo["documentStatus"] == "on_hand") echo "checked"; ?>><span>ON-HAND</span></label>
                    <label><input type="radio" id="documentStatus" name="documentStatus" value="review" <?php if($rowmo["documentStatus"] == "review") echo "checked"; ?>><span>REVIEW</span></label>
                    <label><input type="radio" id="documentStatus" name="documentStatus" value="graded" <?php if($rowmo["documentStatus"] == "graded") echo "checked"; ?>><span>MARK</span></label>
             
            <?php }elseif($rowmo['documentStatus']=='graded'){?>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="submitted" <?php if($rowmo["documentStatus"] == "submitted") echo "checked"; ?>><span>RECEIVED</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="on_hand" <?php if($rowmo["documentStatus"] == "on_hand") echo "checked"; ?>><span>ON-HAND</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="review" <?php if($rowmo["documentStatus"] == "review") echo "checked"; ?>><span>REVIEW</span></label>
                    <label id="status"><input type="radio" id="documentStatus" name="documentStatus" value="graded" <?php if($rowmo["documentStatus"] == "graded") echo "checked"; ?>><span>GRADED</span></label>
