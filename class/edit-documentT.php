...
function edit(){
   ...
   $pos = $user['position'];
    ...
    $trans = "INSERT INTO document_transaction (documentID, documentName, documentType, documentOwner, createdby, submittedTo, documentStatus, remarks) VALUES ('$documentID', '$documentName', '$documentType', '$documentOwner', '$createdby', '$submittedTo', '$documentStatus', '$remarks')";
...
function delete(){
    ...
    $query = "DELETE FROM document WHERE id = '$id' OR documentOwner = '$id'";
	$queryrun = mysqli_query($conn,$query);
