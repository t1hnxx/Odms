...
<nav class="navbar fixed-top shadow-lg" style="background-color: #ec6d18; color: white; top: 0; width: 100%; height: auto; ">
	<div class="d-flex flex-row container-fluid">
		...
		<div class="d-inline-block align-text-top me-1 fs-6 text-white">
			<a href="profile.php?url=<?php echo $user['facultyID'] . '%'.$user['urlAddress']?>" class="text-white" class="text-white fw-bold" style="text-decoration:none; letter-spacing: 1px">
      <?php
          $id = $user['facultyID'];
...
<div class="container-xxl bd-gutter mt-3 my-md-4 bd-layout">
    ...
    <div class="row">
    <div class="col-lg-4">
        <div class="card mb-4 text-bg-secondary border-dark">
     ...
     <div class="card mb-4">
        <div class="alert-message"></div>
          ...
          <div class="row">
              ...
              <input type="text"  value="<?=$user['facultyEmail']?>" class="form-control border-danger border-2" id="facultyEmail" name="facultyEmail" placeholder="<?php echo $user['facultyEmail'];?>" aria-label="Username" aria-describedby="basic-addon1" disabled>
            </div>
            </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
              <div class="input-group mb-3">
              <input type="text"  value="<?=$user['facultyFname']?>" class="form-control border-black" id="facultyFname" name="facultyFname" placeholder="<?php echo $user['facultyFname'];?>" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
              <div class="input-group mb-3">
              <input type="text"  value="<?=$user['facultyMname']?>" class="form-control border-black" id="facultyMname" name="facultyMname" placeholder="<?php echo $user['facultyMname'];?>" aria-label="Username" aria-describedby="basic-addon1" >
            </div>
            </div>
            </div>
            <hr>
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
              <div class="input-group mb-3">
              <input type="text"  value="<?=$user['facultyLname']?>" class="form-control border-black" id="facultyLname" name="facultyLname" placeholder="<?php echo $user['facultyLname'];?>" aria-label="Username" aria-describedby="basic-addon1" >
            </div>
            </div>
            </div>
            <hr>
      ...
      <div class="row">
              ...
              <div class="col-sm-9">
              <div class="input-group mb-3">
              <input type="password" value="<?=$user['facultyPassword']?>" class="form-control border-black" id="facultyPassword" name="facultyPassword" placeholder="Type your new password" aria-label="Username" aria-describedby="basic-addon1" required>
            </div>
            </div>
            </div>
            <hr>
...
<?php
    if(isset($_FILES["image"]["name"])){
      ...
      elseif ($imageSize > 1200000){
        ...
        $query = "UPDATE faculty_info SET Fprofile_image = '$newImageName' WHERE facultyID = '$id'";
