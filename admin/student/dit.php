<?php 
$query = "SELECT * FROM student_info WHERE studentCourse = 'BSIT' OR studentCourse = 'BSCS' ORDER BY studentLname";
$result = mysqli_query($conn,$query); 

?>
<div>
  <button onclick="printSdit()" class="btn btn-flat btn-success float-start" id="prints"><i class="bi bi-printer"></i>&nbsp Print</button>
</div>
<br>
<br>
<div class="container text-white" id="sdit">
  <table class='table table-responsive-sm table-striped table-bordered border-dark' id="sdit">
...
function printSdit() {
  var _el = $('<div>')
            ...
            p.find('#photo').hide()
            p.find('#sdit').removeClass("table-striped").addClass("border-black")       
