<?php 
$query = "SELECT * FROM student_info WHERE studentCourse = 'BS Arch' OR studentCourse = 'BSIE' OR  studentCourse = 'BSCE' ORDER BY studentLname";
$result = mysqli_query($conn,$query); 

?>
<div>
  <button onclick="printSdcea()" class="btn btn-flat btn-success float-start" id="prints"><i class="bi bi-printer"></i>&nbsp Print</button>
</div>
<br> <br>
<div class="container text-white" id="sdcea">
  <table class='table table-responsive-sm table-striped table-bordered border-dark' id="sdcea">
...
function printSdcea() {
  var _el = $('<div>')
            ...
            p.find('#photo').hide()
            p.find('#sdcea').removeClass("table-striped").addClass("border-black")       
