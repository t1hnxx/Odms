<?php 
$query = "SELECT * FROM student_info WHERE studentCourse = 'BSCpE' OR studentCourse = 'BSEE' OR  studentCourse = 'BSECE' ORDER BY studentLname";
$result = mysqli_query($conn,$query); 

?>
<div>
  <button onclick="printSdcee()" class="btn btn-flat btn-success float-start" id="prints"><i class="bi bi-printer"></i>&nbsp Print</button>
</div>
<br><br>
<div class="container text-white" id="sdcee">
  <table class='table table-responsive-sm table-striped table-bordered border-dark' id="sdcee">
...
function printSdcee() {
  var _el = $('<div>')
            ...
            p.find('#photo').hide()
            p.find('#sdcee').removeClass("table-striped").addClass("border-black")       
