<?php 
$query = "SELECT * FROM student_info WHERE studentCourse = 'BSIndT-ET' OR studentCourse = 'BSIndT-ELEX' OR  studentCourse = 'BSIndT-AT' ORDER BY studentLname";
$result = mysqli_query($conn,$query); 

?>
<div>
  <button onclick="printSdiet()" class="btn btn-flat btn-success float-start" id="prints"><i class="bi bi-printer"></i>&nbsp Print</button>
</div>
<br><br>
<div class="container text-white" id="sdiet">
  <table class='table table-responsive-sm  table-striped table-bordered border-dark' id="sdiet">
...
function printSdiet() {
  var _el = $('<div>')
            ...
            p.find('#photo').hide()
            p.find('#sdiet').removeClass("table-striped").addClass("border-black")       
