...
include("../dbcon.php"); 
	...
	if(isset($_POST['request'])){
		...
		$query1 = "SELECT * FROM users_documents WHERE documentType = '$request' AND facultyDepartment = 'DCEE'";
		$result1 = mysqli_query($conn, $query1);
		$count = mysqli_num_rows($result1);
	
    if($count > 0){
      $output = " <thead class='fw-bolder table-dark align-middle' id='headcee'>
      <tr>
      <td>Date Created</td>
