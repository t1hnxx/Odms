    ...
    <div class="container">
        <div class="row">
            <div class="card shadow border border-secondary">
                ...
                <h5 style="color:#ec6d18"><b> Student Information </b></h5>
                 </div>
                 <div class="card-body">
                    ...
                    <form action="#" method="POST" id="add_prsnnl">
                        ...
                        <div class="row mb-3">
                                <div class="col-md-4 input-group-sm">
                                    <label for="studentNum" class="form-label fs-6 text-dark fw-bolder">Student Number</label>
                                    <input class="form-control border-dark" type="text" name="studentNum[]" id="studentNum" required>
                                </div>
                            </div>
                            
                            <div class="row mb-3">
                                <div class="col-md-4 input-group-sm">
                                    <label for="studentFname" class="form-label fs-6 text-dark fw-bolder">First Name</label>
                                    <input class="form-control border-dark" type="text" name="studentFname[]" required>
                                </div>

                                <div class="col-md-4 input-group-sm">
                                    <label for="studentMname" class="form-label fs-6 text-dark fw-bolder">Middle Name (optional)</label>
                                    <input class="form-control border-dark" type="text" name="studentMname[]">
                                </div>

                                <div class="col-md-4 input-group-sm">
                                    <label for="studentLname" class="form-label fs-6 text-dark fw-bolder">Last Name</label>
                                    <input class="form-control border-dark" type="text" name="studentLname[]" required>
                                </div>

                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4 input-group-sm">
                                <label for="studentEmail" class="form-label fs-6 text-dark fw-bolder">Email</label>
                                    <input class="form-control border-dark " type="email" name="studentEmail[]" required>
                                </div>

                                <div class="col-md-4 input-group-sm">
                                <label for="studentGender" class="form-label fs-6 text-dark fw-bolder">Sex</label>
                                    <select class="form-select form-select-sm border-dark" name="studentGender[]" aria-label="Small select example" required>
                                ...
                                <div class="col-md-4 input-group-sm">
                                <label for="studentCourse" class="form-label fs-6 text-dark fw-bolder">Program</label>
                                <?php
                                    ...
                                    <label for="studentCourse" class="form-label fs-6">Program</label>
                                    <select class="form-select form-select-sm border-dark" name="studentCourse[]" aria-label="Small select example" required>
                                        <option value=""disabled selected hidden></option>
                                    <?php
