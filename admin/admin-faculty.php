...
<br><br><br>
	...
	<div class="row">
	 ...
	 <div class="col-md-10 mt-1">
		...
		<button  class="btn btn-flat float-start text-white" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color:#ec6d18"><b><i class="bi bi-person-plus"></i>&nbsp Add Faculty</b></button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>Add Faculty</b></h5> <sub><button type="button" class="btn"
...
<div class="tab-content" id="nav-tabContent">
  ...
  <div class="tab-pane fade" id="nav-dce" role="tabpanel" aria-labelledby="nav-dce-tab" tabindex="0"><?php include("faculty/dcea.php"); ?></div>
...
$(document).ready(function() {
  $('#deleteButton').click(function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        $(".alert-message").html(response); // Handle success response (e.g., refresh table)
      },
      error: function(jqXHR, textStatus, errorThrown) {
        // Handle error response
      }
