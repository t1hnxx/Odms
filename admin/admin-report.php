	 ...
	 <div class="col-md-10 mt-1">
		...
		<ul class="nav nav-underline" id="nav-tab" role="tablist">
          ...
          <!--  <li class="nav-item">
           ...
           <!-- <li class="nav-item">
                <a class="nav-link" id="nav-guidance-tab"   data-bs-toggle="tab" data-bs-target="#nav-guidance" type="button" role="tab" aria-controls="nav-guidance" aria-selected="false" style="color:#ec6d18; font-weight:bolder">Guidance</a>
            </li>-->
         </ul>

<br>
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab" tabindex="0"><?php include("report/all.php");?></div>
  <div class="tab-pane fade" id="nav-dean" role="tabpanel" aria-labelledby="nav-dean-tab" tabindex="0"><?php include("report/dean.php"); ?></div>
  <div class="tab-pane fade" id="nav-dafe" role="tabpanel" aria-labelledby="nav-dafe-tab" tabindex="0"><?php include("report/dafe.php"); ?></div>
  <div class="tab-pane fade" id="nav-dce" role="tabpanel" aria-labelledby="nav-dce-tab" tabindex="0"><?php include("report/dcea.php"); ?></div>
  <div class="tab-pane fade" id="nav-dcee" role="tabpanel" aria-labelledby="nav-dcee-tab" tabindex="0"><?php include("report/dcee.php"); ?></div>
  <div class="tab-pane fade" id="nav-diet" role="tabpanel" aria-labelledby="nav-diet-tab" tabindex="0"><?php include("report/diet.php"); ?></div>
  <div class="tab-pane fade" id="nav-dit" role="tabpanel" aria-labelledby="nav-dit-tab" tabindex="0"><?php include("report/dit.php"); ?></div>
