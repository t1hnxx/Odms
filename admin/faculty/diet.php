<?php 
$query = "SELECT * FROM faculty_info WHERE facultyDepartment = 'DIET' ORDER BY facultyLname";
$result = mysqli_query($conn,$query); 

?>
<div>
  <button onclick="printFdiet()" class="btn btn-flat btn-success float-start" id="prints"><i class="bi bi-printer"></i>&nbsp Print</button>
</div>
<br><br>
<div class="container text-white" id="areafdiet"><table class='table table-responsive-sm table-striped table-bordered border-dark' id="fdiet">
...
function printFdiet() {
  var _el = $('<div>')
            ...
            _el.append('<div class="d-flex flex-row container-fluid">'+
              ...
              p.find('#photo').hide()
              p.find('#fdiet').removeClass("table-striped").addClass("border-black")
...
<script>
  ...
  w = document.getElementById("fdiet");
