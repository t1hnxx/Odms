<?php 
$query = "SELECT * FROM faculty_info WHERE facultyDepartment = 'DIT' ORDER BY facultyLname";
...
<br><br>
<div class="container text-white" id="areafdit"><table class='table table-responsive-sm table-striped table-bordered border-dark' id="fdit">
...
function printFdit() {
  var _el = $('<div>')
            ...
            _el.append('<div class="d-flex flex-row container-fluid">'+
              ...
              p.find('#fdit').removeClass("table-dark table-striped border-white").addClass("border-black") 
            _el.append(p.html())
...
<script>
  ...
  w = document.getElementById("fdit");
